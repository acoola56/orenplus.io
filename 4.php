...
<body>
    ...
    <div class="container">
        ...
        if (!isset($_SESSION['user_id']) || $_SESSION['user_role'] != 'сотрудник') {
        ...
        // Вывод таблицы "Задания" без функционала
        $table = 'Задания'; 
        ...
        // Вывод таблицы "Отчёты" с функционалом добавления и удаления записей
        $table = 'Отчёты'; 
        echo "<div class='table-container' id='$table'>";
        $sqlTable = "SELECT * FROM $table";
        $tableResult = $conn->query($sqlTable);
        ...
        // Обработка добавления и удаления записей
